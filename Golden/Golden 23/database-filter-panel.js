...
function buildDbFilterPanel(topics, types, skipRestore = false) {
  ...
  // Explanation & Reference Display (EXACT GOLDEN 22)
  ...
  // Test Behavior Options (EXACT GOLDEN 22)
  ...
  // Selection Mode section (EXACT GOLDEN 22)
  ...
  startBtn.addEventListener("click", () => {
    ...
    AppState.savedDbOptions = {
      ...
      selectedTypes: Array.from(typeDiv.querySelectorAll('input[type="checkbox"]:checked')).map(cb => cb.value),
      explanationMode: AppState.explanationMode,
      numQuestions: parseInt(document.getElementById("numQuestions").value) || 10,
      selectionMode: modeDiv.querySelector('input[name="selectionMode"]:checked').value,
